                ...
                return (
                  <li key={s.id}>
                    <div className="group flex h-full flex-col rounded-2xl border border-zinc-200/90 bg-white p-6 shadow-sm transition hover:border-zinc-300 hover:shadow-md">
                      ...
                      {/* 圖表預留位置 */}
                      <div className="bg-zinc-50 border border-dashed border-zinc-300 rounded-2xl h-[280px] flex items-center justify-center mb-3">
                        <div className="text-center">
                          <div className="text-5xl mb-3 opacity-40">📈</div>
                          <p className="font-medium text-zinc-400">策略 vs 大盤績效</p>
                          <p className="text-xs text-zinc-400 mt-1">圖表由 GitHub Actions 自動更新</p>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-1.5">
                        <div className="rounded-2xl bg-white border p-2.5">
                          <div className="flex items-center gap-2 text-emerald-600">
                            ...
                            <span className="text-xs font-medium">年化報酬</span>
                          </div>
                        ...
                        <div className="rounded-2xl bg-white border p-2.5">
                          <div className="flex items-center gap-2 text-emerald-600">
                            <span className="text-lg">📅</span>
                            <span className="text-xs font-medium">今年報酬</span>
                          </div>
                          <div className="mt-2 text-[24px] font-bold text-emerald-600">
