...
export default function StrategyPage() {
  ...
  return (
    <AppSidebarLayout contentClassName="max-w-[960px] mx-auto" flushTopOnLandscape>
      {/* 外層容器優化：
        將原本的 h-[calc(100vh-5rem)] 升級為 h-[calc(100dvh-5rem)]。
        dvh 能夠精準感知手機瀏覽器下方工具列的存在，徹底解決手機直式下底部資料被吃掉的物理死角。
      */}
      <div className="flex h-[calc(100dvh-5rem)] min-h-0 flex-col sm:h-[calc(100dvh-5rem)] max-w-[960px] mx-auto overflow-hidden landscape:max-md:fixed landscape:max-md:inset-0 landscape:max-md:h-dvh landscape:max-md:max-w-none landscape:max-md:mx-0 landscape:max-md:w-[calc(100%+2rem)] landscape:max-md:-mx-4 landscape:max-md:overflow-hidden landscape:max-md:pl-10">
