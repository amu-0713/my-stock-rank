...
export default function RankList({
  ...
  const gridCols = isFilteredRankList 
    ? 'grid-cols-[60px_minmax(95px,170px)_72px_65px_65px_65px_100px_75px]' 
    : showFilterColumn 
      ? 'grid-cols-[60px_minmax(95px,170px)_72px_65px_65px_65px_100px_60px]' 
      : 'grid-cols-[64px_minmax(150px,220px)_80px_75px_75px_75px_160px]'

  const minWidth = (isFilteredRankList || showFilterColumn) ? 'min-w-[780px]' : 'min-w-[680px]'
      ...
      <div className="min-h-0 flex-1 overflow-auto -webkit-overflow-scrolling-touch">
        <div className={`${minWidth}`}>
          {loading ? (
            ...
            <>
              <div className={`sticky top-0 z-10 grid ${gridCols} items-center gap-1 border-b border-zinc-200 bg-white px-4 py-4 text-sm font-semibold text-zinc-600 shadow-sm landscape:max-md:px-3 landscape:max-md:py-1 landscape:max-md:max-h-[40px] landscape:max-md:min-h-[40px]`}>    
