...
function ScoreModal({ stock, onClose }) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/80 backdrop-blur-sm" onClick={onClose}>
     <div className="bg-white rounded-3xl w-full max-w-lg landscape:max-md:max-w-[340px] landscape:max-md:mx-3 shadow-2xl overflow-hidden pointer-events-auto mx-4" onClick={e => e.stopPropagation()}>
        {/* ScoreModal 內容保持不變 */}
        <div className="p-6 border-b flex justify-between items-start landscape:max-md:p-4">
          <div>
       ...
       <div className="p-6 landscape:max-md:p-4">
          <div className="text-sm font-bold text-zinc-500 mb-6 uppercase tracking-wider">
           ...
           <div className="relative h-[280px] landscape:max-md:h-[210px] w-full border border-zinc-100 rounded-2xl bg-zinc-50/50 p-4 landscape:max-md:p-3">
